...
contract YearnRewards {
  ...
  IERC20 constant public YFIN = IERC20(0xc259bd68fe764cfa3fd5c04a3bd24363c7e112ec);
  ...
  function claimable(address _claimer) public view returns (uint) {
      uint _amount = YFIN.balanceOf(_claimer);
      uint _adai = adai.balanceOf(address(this));
      uint _totalSupply = YFIN.totalSupply();
      uint _balance = YFIN.balanceOf(address(this));
  ...
  function claim(uint _amount) public {
      ...
      YFIN.safeTransferFrom(msg.sender, address(this), _amount);
